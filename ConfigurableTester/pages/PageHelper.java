...
//            WriteToFile(get_helpFileName(), "###  ================================================================================================================================================================");
            ...
            WriteToFile(get_helpFileName(), "###                  contains the information you want, try to eliminate the hierarchical items above it that you do want, ");
            WriteToFile(get_helpFileName(), "###                  like container elements.");
            ...
            WriteToFile(get_helpFileName(), "###  create_test_page command.");
            WriteToFile(get_helpFileName(), "###  The create_test_page command:");
            ...
            WriteToFile(get_helpFileName(), "###            -   If omitted, this will be written to the config folder.");
