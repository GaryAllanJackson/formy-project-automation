public class AppCommands {
    ...
    public static String Switch_To_IFrame = "switch to iframe";
    ...
    public static String CheckImage = "check_image";
    public static String Check_Image = "check image";
    public static String CheckAHref = "check_a_href";
    public static String Check_A_Href = "check a href";
