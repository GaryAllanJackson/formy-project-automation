public class AppConstants {
    ...
    public static final String persistedStringCheckValue = "persistedstring";
    public static final String xpathCheckValue = "xpath";
    public static final String cssSelectorCheckValue = "cssselector";
    public static final String tagNameCheckValue = "tagname";
    public static final String idCheckValue = "id";
    public static final String classNameCheckValue = "classname";
    //endregion
...
//    public static final String subsectionLeft = "     «══════════════[ ";
    ...
    public static final String uidReplacementChars = "**_uid_**";
