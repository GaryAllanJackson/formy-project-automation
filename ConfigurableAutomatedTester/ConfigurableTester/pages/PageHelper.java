...
//            WriteToFile(get_helpFileName(), "###  =========[ CHECK AN ANCHOR HREF ]=======================================================================================================================");
            ...
            WriteToFile(get_helpFileName(), "╠//*[@id=\"menu-item-21\"]/a ; check_a_href https://www.swtestacademy.com/about-software-test-academy/ ; xPath ; false ; false╣");
            WriteToFile(get_helpFileName(), "###  " + PrePostPad("═", "═", 1, 159));
            WriteToFile(get_helpFileName(), "");
...
//            WriteToFile(get_helpFileName(), "###  =========[ CHECK THE COUNT OF A SPECIFIC ELEMENT ON A PAGE ]=======================================================================================================================");
            ...
            WriteToFile(get_helpFileName(), "╠n/a ; check count a ╬ 18 ; n/a ; false ; false╣");
            WriteToFile(get_helpFileName(), "###  " + PrePostPad("═", "═", 1, 159));
            WriteToFile(get_helpFileName(), "");
...
//            WriteToFile(get_helpFileName(), "###  =========[ RETRIEVING TEXT FROM AN ELEMENT AND MAKING A NOT EQUAL ASSERTION ]====================================================================================================================");
